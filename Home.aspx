...
<!-- header -->
	<div class="header_bg">
		<div class="container">
			...
			<div class="header">
				<div class="logo">
					<a href="Home.aspx"><img src="images/1499925698AjayKumarGargEngineeringCollege.png" style="margin-left:-100px; margin-top:25px" alt=" " class="auto-style1" /></a>
				</div>
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav" style="font-size:15px;">
							...
							<li><a href="FinalResult.aspx"><strong>Results</strong></a></li>
							<li><a href="Login.aspx"><strong>Login</strong></a>
			...
			<div class="wlcome-grids">
				<div class="col-md-7 wlcome-grid-left">
					<div class="election_grid">
						<h3>Welcome To AKGEC CR Voting Website!</h3>
			...
			<div class="footer-grids">
				<div class="col-md-3 footer-grid">
					<p>Ajay Kumar Garg Engineering College,
                        ...
                        Ghaziabad-201009,
                        Uttar Pradesh, India
					<a href="mailto:Shobhit6june@gmail.com">Email : Admin AKGEC Voting Website</a>
